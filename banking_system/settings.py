...
ALLOWED_HOSTS = ['7450-49-205-97-119.ngrok-free.app', 'localhost', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://7450-49-205-97-119.ngrok-free.app']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'authenticatorforbankproject@gmail.com'#Type MANAGER EMAIL
EMAIL_HOST_PASSWORD = 'sqsm xyku vuaf xzbf'  # Use an app password if using Gmail
